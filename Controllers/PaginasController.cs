...
namespace admin_cms.Controllers
{
    ...
    public class PaginasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Conteudo,Login,AreaRestrita,Home,Ordem")] Pagina pagina)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Conteudo,Login,AreaRestrita,Home,Ordem")] Pagina pagina)
        {
            if (id != pagina.Id)
            {
                return NotFound();
